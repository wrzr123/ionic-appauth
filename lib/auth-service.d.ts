...
export declare class AuthService implements IAuthService {
    ...
    protected performEndSessionRequest(state?: string, idTokenHint?: string): Promise<void>;
    ...
    protected requestTokenWithClientCredentials(): Promise<void>;
    ...
    tokenWithClientCredentials(): Promise<void>;
